...
// Optimized WebP: small and large
...
const artworks: Artwork[] = [
  ...
  { id: 10, smallSrc: smOhneTitelA, largeSrc: lgOhneTitelA, alt: "Blaugrün", title: "Blaugrün", year: "2024", dimensions: "je 80 x 40 cm", groupId: "ohne-titel-diptych", img: { w: 301, h: 600, top: 4170, left: 1089 }, caption: { w: 196, top: 4299, left: 467, align: "right" } },
  { id: 11, smallSrc: smOhneTitelB, largeSrc: lgOhneTitelB, alt: "Blaugrün", title: "", year: "", dimensions: "", groupId: "ohne-titel-diptych", img: { w: 299, h: 600, top: 4170, left: 790 } },
            ...
            <div className="relative">
              ...
              {(
                [
                  ...
                  { id: 2, imageClass: "absolute w-[247px] h-[244px] top-[353px] left-[137px] object-cover cursor-pointer", textClass: "absolute w-25 top-[497px] left-[68px] [font-family:'Antonio',Helvetica] font-normal text-black text-base text-right tracking-[-0.32px] leading-[19.2px]" },
                  { id: 3, imageClass: "absolute w-[315px] h-[157px] top-[609px] left-3 object-cover cursor-pointer", textClass: "absolute w-[66px] top-[654px] left-[328px] [font-family:'Antonio',Helvetica] font-normal text-black text-base tracking-[-0.32px] leading-[19.2px]" },
                  { id: 4, imageClass: "absolute w-[280px] h-auto top-[801px] left-[0px] object-contain cursor-pointer", textClass: "absolute w-[100px] top-[850px] left-[290px] [font-family:'Antonio',Helvetica] font-normal text-black text-left tracking-[-0.32px] leading-[19.2px]" },
                  { id: 5, imageClass: "absolute w-[302px] h-80 top-[1127px] left-[82px] object-cover cursor-pointer", textClass: "absolute w-20 top-[1210px] left-[-5px] [font-family:'Antonio',Helvetica] font-normal text-black text-base text-right tracking-[-0.32px] leading-[19.2px]" },
                  ...
                  { id: 13, imageClass: "absolute w-[286px] h-[190px] top-[2814px] left-[88px] object-cover cursor-pointer", textClass: "absolute w-[75px] top-[2832px] left-[8px] [font-family:'Antonio',Helvetica] font-normal text-black text-base text-right tracking-[-0.32px] leading-[19.2px]" },
                  { id: 14, imageClass: "absolute w-[281px] h-[283px] top-[3034px] left-[11px] object-cover cursor-pointer", textClass: "absolute w-[75px] top-[3167px] left-[306px] [font-family:'Antonio',Helvetica] font-normal text-black text-base tracking-[-0.32px] leading-[19.2px]" }
                ]
              ).map((item) => {
